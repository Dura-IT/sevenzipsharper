...
namespace SevenZipSharper.IntegrationTests
{
    ...
    public sealed class CompressionParameterMatrixTests
    {
        ...
        public static IEnumerable<TestCaseData> MatrixCases()
        {
            ...
            yield return new TestCaseData(ArchiveFormat.SevenZip, CompressionMethod.Lzma2, CompressionLevel.Normal, (int?)2).SetName(
                "7z_Lzma2_Normal_2Threads"
            );
            yield return new TestCaseData(ArchiveFormat.SevenZip, CompressionMethod.Lzma2, CompressionLevel.Normal, (int?)4).SetName(
                "7z_Lzma2_Normal_4Threads"
            );
